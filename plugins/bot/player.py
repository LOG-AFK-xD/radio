...
async def not_chat(_, m: Message):
    buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://heroku.com/deploy?template=https://github.com/OFFICIAL-AFK-XD/LOVELY-ROBOT"),
            ]
         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/54b8fa9c6c58f9db7c453.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Make Your Own Bot Like This From The [DEVELOPER](t.me/Official_afk_xD) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
